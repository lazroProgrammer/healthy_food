...
class FormalBubblesSearchPage extends StatelessWidget {
  const FormalBubblesSearchPage({required this.designIndex, super.key});
                ...
                ClipRRect(
                  ...
                  child: BackdropFilter(
                    filter: ImageFilter.blur(
                        ...
                        sigmaY: filterVals[designIndex],
                        tileMode: TileMode.decal),
                    child: ResultList(color: cardColors[designIndex]),
                  ),
                ),
              ]),
            ),
