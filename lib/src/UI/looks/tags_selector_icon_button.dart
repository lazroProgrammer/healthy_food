...
class TagSelectorIconButton extends ConsumerWidget {
  const TagSelectorIconButton({super.key});
  @override
...
class CategorySelectorModal extends ConsumerStatefulWidget {
  ...
  const CategorySelectorModal({super.key, required this.initialTags});

  @override
  CategorySelectorModalState createState() => CategorySelectorModalState();
}

class CategorySelectorModalState extends ConsumerState<CategorySelectorModal> {
  // categories = [
  //   'Beverages',
  //   'Snacks',
  //   'Waters',
